            ...
            <TouchableOpacity style={{
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <View style={{ paddingHorizontal: wp(3.5), width: wp(45) }}>
                        <Text style={{ paddingVertical: hp(0.5), fontSize: hp(2), color: COLORS.darkgray, fontFamily: fontFamily.FONTS.bold }} numberOfLines={1}>{productName}</Text>
                        <Text style={{ paddingVertical: hp(0.1), fontSize: hp(1.6), color: COLORS.darkgray1, fontFamily: fontFamily.FONTS.Medium }} numberOfLines={2}>{productSubtitle}</Text>
                    </View>
                </View>
